...
The `notebooks_evaluated/` folder contains fully executed versions of all existing notebooks, generated by running each notebook end-to-end with no errors. They serve as a reference showing expected outputs and figures. They are generated with:
...
**Prerequisites:** N01, N02; thermodynamics  
